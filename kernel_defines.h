...
#ifndef PRELOAD_CACHE_LINE_SIZE
#define PRELOAD_CACHE_LINE_SIZE 32
#endif

#ifdef PRELOAD_OFFSET
#define PREFETCH_DISTANCE (PRELOAD_OFFSET / PRELOAD_CACHE_LINE_SIZE)
#else
#if __LINUX_ARM_ARCH__ >= 7
#define PREFETCH_DISTANCE (256 / PRELOAD_CACHE_LINE_SIZE)
#else
#define PREFETCH_DISTANCE (128 / PRELOAD_CACHE_LINE_SIZE)
#endif
#endif

#if defined(USE_NEON) && PRELOAD_CACHE_LINE_SIZE == 64
